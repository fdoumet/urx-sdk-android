...
public class JsonPath {
     ...
     * the {@link com.jayway.jsonpath.spi.JsonProvider}
     *
    ...
    /**
     * Creates a {@link com.jayway.jsonpath.ParseContext} that can be used to parse a given JSON input.
     *
     ...
     * returns a {@link com.jayway.jsonpath.ReadContext} for path evaluation
     *
     * @param json input
